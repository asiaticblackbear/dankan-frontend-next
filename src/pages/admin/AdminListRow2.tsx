...
function ListRowTexts({obj}: { obj: User }) {
    return (
        <Flex direction="column">
            <Spacing size={8}/>
            <Flex direction="row" align="center">
                <Text typography="t6" color="dankanPrimary" bold={true}>{obj.nime} </Text>
                <Spacing direction="horizontal" size={8}/>
                <Text typography="t10" color="dankanGray">({obj.point} point)</Text>
            </Flex>
            <Spacing size={8}/>
            <Flex direction="row">
                <Text typography="t10" color="black">{obj.univZipCd}</Text>
                <Spacing direction="horizontal" size={2}/>
                <Text typography="t10" color="black" bold={true}>·</Text>
                <Spacing direction="horizontal" size={2}/>
                <Text typography="t10" color="black">{obj.homeZipCd}</Text>
            </Flex>
        </Flex>
    )
}
